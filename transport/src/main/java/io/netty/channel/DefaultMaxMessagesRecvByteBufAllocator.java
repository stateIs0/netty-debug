...
public abstract class DefaultMaxMessagesRecvByteBufAllocator implements MaxMessagesRecvByteBufAllocator {
    ...
    public abstract class MaxMessageHandle implements ExtendedHandle {
        ...
        @Override
        public ByteBuf allocate(ByteBufAllocator alloc) { // guess() 返回  return nextReceiveBufferSize
            return alloc.ioBuffer(guess());// // 当支持 Unsafe 时，返回直接内存的 Bytebuf，否则返回返回基于堆内存，当使用 PreferHeapByteBufAllocator 时返回堆内存
        }
